...
Util.buildManagementView = async function (){
  let management = ''
  management += '<a href="/inv/add-classification" class="form-button">Add New Classification</a><br>'
  management += '<a href="/inv/add-inventory" class="form-button">Add New Vehicle</a>'
  return management
}
